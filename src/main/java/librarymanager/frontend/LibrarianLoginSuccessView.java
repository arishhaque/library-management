...
public class LibrarianLoginSuccessView extends JFrame {
	static LibrarianLoginSuccessView frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame = new LibrarianLoginSuccessView();
	 ...
	 * Create the frame.
	 */
	public LibrarianLoginSuccessView() {
		...
		btnIssueBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IssueNewBookView.main(new String[]{});
				frame.dispose();
			}
		});
		...
		btnReturnBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ReturnBookView.main(new String[]{});
				frame.dispose();
			}
		});
		...
		btnLogout.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				LibraryMainView.main(new String[]{});
				frame.dispose();
			}
		});
