...
public class LibrarianDeleteView extends JFrame {
	static LibrarianDeleteView frame;
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(sid==null||sid.trim().equals("")){
					...
					if(i>0){
						...
						JOptionPane.showMessageDialog(LibrarianDeleteView.this,"Unable to delete given id!");
					}
				}
			}
		});
